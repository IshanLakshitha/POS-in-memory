...
//        tblItemsTable.getColumns().get(0).setStyle("-fx-alignment: center");
//        tblItemsTable.getColumns().get(2).setStyle("-fx-alignment: center-right");
//        tblItemsTable.getColumns().get(3).setStyle("-fx-alignment: center-right");
    ...
    void ClickDelete(ActionEvent event) {
        ...
        if (buttonType.get() == ButtonType.YES) {
            int selectedRow = tblItemsTable.getSelectionModel().getSelectedIndex();
